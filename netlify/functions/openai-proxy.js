...
const MEMORY_TRIGGERS = [
  ...
  /was wei[sß]t du/i,
  /erz[äa]hl mir von/i,
  /(?:sabine|freundin(?:nen)?).*(?:erinner|wei[sß]t|kennengelernt|wodurch|damals|intensive zeit)/i,
  /(?:erinner|wei[sß]t|kennengelernt|wodurch|damals|intensive zeit).*(?:sabine|freundin(?:nen)?)/i,
  /do you remember/i,
  /tell me about/i,
  /what did we/i,
  /when did i/i,
